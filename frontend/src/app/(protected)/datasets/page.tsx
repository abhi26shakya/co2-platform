...
import { ImageRow } from "@/features/datasets/components/datasets/image-row";
import { Card } from "@/components/ui/card";
import { Input } from "@/components/ui/input";
import { useImages } from "@/features/datasets/hooks/use-images";
      ...
      <Card className="mt-4 px-5">
        {isLoading ? (
          ...
          <ul className="divide-y divide-ground-700">
            {data?.items.map((img: ImageOut) => <ImageRow key={img.id} image={img} />)}
          </ul>
        )}
      </Card>
