...
export function InspectorDrawer({ open, onClose, facility, timelinePeriod, sliderIndex }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-40 flex justify-end">
      ...
      <Card className="relative w-full max-w-md h-full rounded-none border-l border-ground-700 bg-ground-950 overflow-y-auto p-5 space-y-4 animate-in slide-in-from-right duration-200">
